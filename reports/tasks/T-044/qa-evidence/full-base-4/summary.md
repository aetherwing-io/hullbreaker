...
- Started: 2026-08-02T09:09:27.505Z
- Wall time: 241.3s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.3ms / max 129ms (3158 samples)
...
- Stock lives (source: telemetry): 3 → 1, **2 spent** (at 3.0s x 31.649→2.515, 28.5s x 61.298→51.5)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 21.9s of 241.0s PLAYING time (fraction 0.091)
- Airborne time (`airMs`): 216.9s
- Closest approach to crush edge (`minEdgeMargin`): 3.59 tiles
- Vertical range: y -5.31–12.01 (span 17.33)
...
- Hostiles seen: up to 8 concurrent (carrier, hound, wasp) on 3158/3158 sampled ticks
