...
- Started: 2026-08-02T09:13:37.062Z
- Wall time: 37.3s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.5ms / max 133ms (485 samples)
...
- Kills: 7, hits survived: 4
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 3.0s x 31.649→2.531, 28.4s x 60.891→51.5, 36.5s x 60.604→60.604)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.6s of 36.6s PLAYING time (fraction 0.044)
- Airborne time (`airMs`): 32.8s
...
- Hostiles seen: up to 8 concurrent (carrier, hound, wasp) on 485/485 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 36.5s (advanced 36.4s); stop reason: game-over
