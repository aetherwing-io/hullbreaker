...
- Started: 2026-08-02T08:48:49.126Z
- Wall time: 47.4s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.4ms / max 126ms (617 samples)
...
- Kills: 8, hits survived: 4
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 3.0s x 31.649→2.551, 28.3s x 61.304→51.5, 46.6s x 113.249→113.954)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.9s of 46.6s PLAYING time (fraction 0.041)
- Airborne time (`airMs`): 42.0s
- Closest approach to crush edge (`minEdgeMargin`): 3.59 tiles
- Vertical range: y -5.62–12.01 (span 17.63)
...
- Hostiles seen: up to 8 concurrent (carrier, hound, wasp) on 617/617 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 46.6s (advanced 46.5s); stop reason: game-over
