...
- Started: 2026-08-02T08:46:59.017Z
- Wall time: 52.6s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.4ms / max 125ms (685 samples)
...
- Kills: 9, hits survived: 4
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 3.0s x 31.649→2.531, 38.5s x 90.393→64.547, 51.8s x 148.128→147.728)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.6s of 51.8s PLAYING time (fraction 0.031)
- Airborne time (`airMs`): 46.8s
- Closest approach to crush edge (`minEdgeMargin`): 3.79 tiles
- Vertical range: y -5.63–12.01 (span 17.64)
...
- Hostiles seen: up to 10 concurrent (carrier, hound, wasp) on 685/685 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 51.8s (advanced 51.7s); stop reason: game-over
