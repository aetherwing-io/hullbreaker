...
- Started: 2026-08-02T08:46:00.762Z
- Wall time: 49.8s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.4ms / max 125ms (648 samples)
...
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 28.8s x 77.277→51.5, 44.1s x 127.575→83.5, 48.9s x 119.521→119.835)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.1s of 49.0s PLAYING time (fraction 0.022)
- Airborne time (`airMs`): 42.7s
- Closest approach to crush edge (`minEdgeMargin`): 3.59 tiles
- Vertical range: y 2–10.22 (span 8.22)
...
- Hostiles seen: up to 8 concurrent (carrier, hound, wasp) on 648/648 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 48.9s (advanced 48.9s); stop reason: game-over
