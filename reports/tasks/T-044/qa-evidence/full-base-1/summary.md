...
- Started: 2026-08-02T08:59:10.969Z
- Wall time: 52.5s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.4ms / max 134ms (684 samples)
...
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 3.0s x 31.649→2.532, 38.5s x 90.472→64.573, 51.7s x 148.155→147.924)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.6s of 51.7s PLAYING time (fraction 0.031)
- Airborne time (`airMs`): 46.7s
- Closest approach to crush edge (`minEdgeMargin`): 3.73 tiles
- Vertical range: y -5.44–12.01 (span 17.45)
...
- Hostiles seen: up to 10 concurrent (carrier, hound, wasp) on 684/684 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 51.7s (advanced 51.6s); stop reason: game-over
