...
- Started: 2026-08-02T09:00:04.512Z
- Wall time: 241.2s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.3ms / max 126ms (3159 samples)
...
- Stock lives (source: telemetry): 3 → 1, **2 spent** (at 3.0s x 31.649→2.531, 28.5s x 60.839→51.5)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 22.1s of 240.9s PLAYING time (fraction 0.092)
- Airborne time (`airMs`): 216.9s
- Closest approach to crush edge (`minEdgeMargin`): 3.59 tiles
- Vertical range: y -5.18–12.01 (span 17.19)
