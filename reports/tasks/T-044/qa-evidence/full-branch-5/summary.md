...
- Started: 2026-08-02T08:53:39.876Z
- Wall time: 49.5s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.4ms / max 124ms (645 samples)
...
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 3.0s x 31.649→2.531, 36.7s x 112.865→76.612, 48.7s x 140.411→139.847)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.0s of 48.7s PLAYING time (fraction 0.02)
- Airborne time (`airMs`): 43.9s
...
- Hostiles seen: up to 9 concurrent (carrier, hound, wasp) on 645/645 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 48.7s (advanced 48.7s); stop reason: game-over
