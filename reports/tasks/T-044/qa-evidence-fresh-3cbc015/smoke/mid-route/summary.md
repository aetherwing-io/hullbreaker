...
- URL: `http://127.0.0.1:8792/index.html?slice=traversal&testapi=1`
- Started: 2026-08-02T10:32:43.968Z
- Wall time: 7.1s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.6ms / max 175ms (90 samples)
...
- Idle time (A.5 `stallMs`): 0.1s of 6.4s PLAYING time (fraction 0.024)
- Airborne time (`airMs`): 5.2s
- Closest approach to crush edge (`minEdgeMargin`): 35.38 tiles
- Vertical range: y 3.17–12.17 (span 9)
...
- Input density (A.5: deliberately NOT a score input): 3.65 events/sec (26 total: 13 down / 13 up)
- protoScore (A.5 formula, proxy airborneKills/links — see README): **86.4** (airborneKills=0, links≈1, airMs=5219, stallMs=150)
