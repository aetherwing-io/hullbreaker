...
- Started: 2026-08-02T10:42:39.760Z
- Wall time: 55.8s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.7ms / max 268ms (725 samples)
...
- Kills: 15, hits survived: 4
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 3.0s x 31.649→2.525, 49.1s x 147.994→116.495, 54.9s x 123.725→123.725)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.5s of 55.1s PLAYING time (fraction 0.028)
- Airborne time (`airMs`): 49.8s
- Closest approach to crush edge (`minEdgeMargin`): 3.58 tiles
- Vertical range: y -5.47–12.02 (span 17.48)
...
- Hostiles seen: up to 9 concurrent (carrier, hound, wasp) on 725/725 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 54.9s (advanced 54.9s); stop reason: game-over
