...
- URL: `http://127.0.0.1:55583/index.html?testapi=1`
- Started: 2026-08-02T05:20:52.897Z
- Wall time: 55.1s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 75.9ms / max 129ms (722 samples)
...
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 31.9s x 98.487→63.5, 48.7s x 154.25→116.5, 54.2s x 125.786→125.781)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 1.7s of 54.3s PLAYING time (fraction 0.031)
- Airborne time (`airMs`): 46.1s
- Closest approach to crush edge (`minEdgeMargin`): 3.37 tiles
- Vertical range: y 2–11.17 (span 9.17)
...
- Events dispatched: **1 of 2**; sim clock reached 54.2s (advanced 54.2s); stop reason: game-over
