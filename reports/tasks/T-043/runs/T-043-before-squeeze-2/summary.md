...
- URL: `http://127.0.0.1:61349/index.html?slice=traversal&hound=2&testapi=1`
- Started: 2026-08-02T04:18:19.215Z
- Wall time: 3.7s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 77.9ms / max 165ms (44 samples)
...
- Idle time (A.5 `stallMs`): 0.8s of 3.3s PLAYING time (fraction 0.25)
- Airborne time (`airMs`): 1.4s
- Closest approach to crush edge (`minEdgeMargin`): 35.42 tiles
- Vertical range: y 2–4.36 (span 2.36)
...
- protoScore (A.5 formula, proxy airborneKills/links — see README): **85.7** (airborneKills=0, links≈3, airMs=1450, stallMs=836)
