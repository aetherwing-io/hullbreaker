...
- URL: `http://127.0.0.1:61386/index.html?slice=traversal&hound=2&testapi=1`
- Started: 2026-08-02T04:18:23.939Z
- Wall time: 3.6s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 77.7ms / max 161ms (44 samples)
...
- Idle time (A.5 `stallMs`): 0.5s of 3.3s PLAYING time (fraction 0.159)
...
- protoScore (A.5 formula, proxy airborneKills/links — see README): **90.9** (airborneKills=0, links≈3, airMs=1676, stallMs=531)
