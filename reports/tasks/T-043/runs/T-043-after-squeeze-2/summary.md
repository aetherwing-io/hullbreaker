...
- Started: 2026-08-02T04:18:37.675Z
- Wall time: 3.6s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 77.7ms / max 157ms (44 samples)
...
- Idle time (A.5 `stallMs`): 1.1s of 3.3s PLAYING time (fraction 0.341)
- Airborne time (`airMs`): 1.4s
- Closest approach to crush edge (`minEdgeMargin`): 35.39 tiles
- Vertical range: y 2–4.98 (span 2.98)
...
- Input density (A.5: deliberately NOT a score input): 1.66 events/sec (6 total: 3 down / 3 up)
- protoScore (A.5 formula, proxy airborneKills/links — see README): **83.2** (airborneKills=0, links≈3, airMs=1444, stallMs=1137)
