...
- Started: 2026-08-02T04:18:42.339Z
- Wall time: 3.7s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 77.9ms / max 176ms (44 samples)
...
- Idle time (A.5 `stallMs`): 0.7s of 3.3s PLAYING time (fraction 0.203)
- Airborne time (`airMs`): 1.6s
- Closest approach to crush edge (`minEdgeMargin`): 35.39 tiles
- Vertical range: y 1–5.18 (span 4.18)
...
- protoScore (A.5 formula, proxy airborneKills/links — see README): **88.8** (airborneKills=0, links≈3, airMs=1607, stallMs=681)
## Deterministic dispatch (input keyed to the game's own clock)
- Events dispatched: **6 of 6**; sim clock reached 3.3s (advanced 3.2s); stop reason: script-window
