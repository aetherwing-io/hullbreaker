...
- Started: 2026-08-02T11:30:10.137Z
- Wall time: 7.1s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 77.1ms / max 186ms (90 samples)
...
- Vertical range: y 3.17–12.19 (span 9.02)
...
- Input density (A.5: deliberately NOT a score input): 3.64 events/sec (26 total: 13 down / 13 up)
- protoScore (A.5 formula, proxy airborneKills/links — see README): **86.8** (airborneKills=0, links≈1, airMs=5255, stallMs=153)
