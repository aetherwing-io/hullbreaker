...
- URL: `http://127.0.0.1:8761/index.html?backdrop=flat&testapi=1`
- Started: 2026-08-02T11:54:21.459Z
- Wall time: 64.6s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.5ms / max 206ms (841 samples)
...
- Stock lives (source: telemetry): 3 → 0, **3 spent** (at 23.6s x 85.746→51.578, 40.8s x 57.061→51.534, 63.8s x 151.219→151.292)

## Pacing / fairness metrics
- Idle time (A.5 `stallMs`): 3.4s of 63.8s PLAYING time (fraction 0.054)
- Airborne time (`airMs`): 52.9s
- Closest approach to crush edge (`minEdgeMargin`): 3.62 tiles
...
- Hostiles seen: up to 8 concurrent (carrier, hound, wasp) on 775/841 sampled ticks
...
- Events dispatched: **1 of 2**; sim clock reached 63.8s (advanced 63.7s); stop reason: game-over
