...
- Started: 2026-08-02T11:41:18.063Z
- Wall time: 7.1s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.9ms / max 178ms (90 samples)
...
- Vertical range: y 3.19–12.24 (span 9.05)
...
- protoScore (A.5 formula, proxy airborneKills/links — see README): **87.5** (airborneKills=0, links≈1, airMs=5313, stallMs=154)
## Deterministic dispatch (input keyed to the game's own clock)
- Events dispatched: **18 of 26**; sim clock reached 6.4s (advanced 6.3s); stop reason: victory
