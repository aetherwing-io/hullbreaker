...
- URL: `http://127.0.0.1:8761/index.html?slice=transform&enemies=0&testapi=1`
- Started: 2026-08-02T11:41:32.005Z
- Wall time: 16.4s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.5ms / max 169ms (212 samples)
...
- Airborne time (`airMs`): 13.5s
- Closest approach to crush edge (`minEdgeMargin`): 30.1 tiles
- Vertical range: y 3–13.18 (span 10.18)
