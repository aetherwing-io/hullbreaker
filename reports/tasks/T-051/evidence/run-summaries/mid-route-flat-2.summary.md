...
- Started: 2026-08-02T11:50:59.728Z
- Wall time: 6.6s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 77ms / max 180ms (83 samples)
...
- Idle time (A.5 `stallMs`): 0.2s of 5.9s PLAYING time (fraction 0.031)
- Airborne time (`airMs`): 3.7s
- Closest approach to crush edge (`minEdgeMargin`): 35.4 tiles
...
- Input density (A.5: deliberately NOT a score input): 3.95 events/sec (26 total: 13 down / 13 up)
- protoScore (A.5 formula, proxy airborneKills/links — see README): **143.5** (airborneKills=0, links≈4, airMs=3748, stallMs=180)
