...
- URL: `http://127.0.0.1:8756/index.html?slice=transform&enemies=0&testapi=1`
- Started: 2026-08-02T02:43:03.969Z
- Wall time: 16.4s
- Fidelity: **testapi**
- Sampling: requested every 75ms, achieved avg 76.1ms / max 150ms (213 samples)
...
- Idle time (A.5 `stallMs`): 0.0s of 15.7s PLAYING time (fraction 0)
- Airborne time (`airMs`): 14.1s
- Closest approach to crush edge (`minEdgeMargin`): 30.09 tiles
- Vertical range: y 3–13.14 (span 10.14)
